...
const Sidebar = () => {
    ...
    const { getUsers, users, selectedUser, setSelectedUser, unseenMessages, setUnseenMessages,resetChat } = useContext(ChatContext);
            ...
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#232142] border border-gray-600 text-gray-100 hidden group-hover:block' >
                            <p onClick={() => navigate('/profile')} className='cursor-pointer text-sm'>Edit Profile</p>
                            <hr className='my-2 border-t border-gray-500' />
                            <p onClick={() => {logout(); resetChat();
